...
class CreateEventTests(BaseAPITestCase):
    ...
    def test_create_event_success_returns_201(self):
        ...
        resp = self.client.post(
            ...
            data={"name": "Journée portes ouvertes", "event_date": "2026-05-15"},
            format="json",
        )
    ...
    def test_create_event_success_returns_correct_fields(self):
        ...
        self.assertIn("event_date", body)
        self.assertIn("created_at", body)
        self.assertEqual(body["name"], "Journée portes ouvertes")
        self.assertEqual(body["event_date"], "2026-05-15")
    ...
    def test_create_event_invalid_date_format_returns_400(self):
        ...
        resp = self.client.post(
            self.create_event_url,
            data={"name": "Journée portes ouvertes", "event_date": "15-05-2026"},
            format="json",
        )
        self.assertEqual(resp.status_code, 400)
    ...
    def test_create_event_empty_name_returns_400(self):
        ...
        resp = self.client.post(
            self.create_event_url,
            data={"name": "", "event_date": "2026-05-15"},
            format="json",
        )
        self.assertEqual(resp.status_code, 400)
    ...
    def test_create_event_duplicate_date_returns_400(self):
        ...
        self.client.post(
            self.create_event_url,
            data={"name": "Premier événement", "event_date": "2026-05-15"},
            format="json",
        )
        resp = self.client.post(
            self.create_event_url,
            data={"name": "Deuxième événement", "event_date": "2026-05-15"},
            format="json",
        )
        self.assertEqual(resp.status_code, 400)
        self.assertIn("event_date", resp.json())
